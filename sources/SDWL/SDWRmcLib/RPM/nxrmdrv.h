...
#define IOCTL_NXRMDRV_CHECK_DWM_HOOK_STATUS	CTL_CODE_NXRMDRV(68)
#define REQUEST_PACKET_OFFSET_SIZE			0x40000
...
#define NXRM_SECTION_MAX_DATA_SIZE			(REQUEST_PACKET_OFFSET_SIZE + 3948)
...
typedef union _NXRMSECTIONHDR{
	...
	UCHAR	raw_hdr[REQUEST_PACKET_OFFSET_SIZE + 4096];
