...
MarshalHelper::MarshalHelper()
{
  ...
  CEMarshalFunc f21(_T("CEEVALUATE_CheckPermissions"),
                    FUNCID_EVALUATE_CHECKPERMISSIONS_Q, 0, NULL,
                    FUNCID_EVALUATE_CHECKPERMISSIONS_P, 0, NULL);
  marshalFuncTbl.push_back(f21);
