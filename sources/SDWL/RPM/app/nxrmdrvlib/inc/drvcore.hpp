...
// it exports 24 functions
#define DRVMAN_FUNCTION_NUMBER  24

class drvcore_man_instance : public dll_instance<DRVMAN_FUNCTION_NUMBER>
{
public:
    ...
    unsigned long post_save_as_forecast_response(HANDLE h, void* context);
    ...
    unsigned long post_update_dwm_window_response(HANDLE h, void* context);
    unsigned long post_update_overlay_window_response(HANDLE h, void* context);
