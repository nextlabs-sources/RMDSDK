// ***************************************************************
//  madCHook.h                version: 3.0.4  ·  date: 2017-03-29
//  -------------------------------------------------------------
//  API hooking & DLL injection
//  -------------------------------------------------------------
//  Copyright (C) 1999 - 2017 www.madshi.net, All Rights Reserved
// ***************************************************************

// 2017-03-29 3.0.4 added HOOK_LOAD_LIBRARY option
// 2017-03-20 3.0.3 added LIMITED_IPC_PORT option
...
// param: bool
// default: false
#define LIMITED_IPC_PORT (DWORD) 0x00000010
...
// param: bool
// default: true
#define HOOK_LOAD_LIBRARY (DWORD) 0x00000011
