            ...
            )
{
	...
	nxWriteToLogFile(L"nxrmvhd!DriverEntry: Enter");
    ...
    Status = NkCryptoInit();
    if (!NT_SUCCESS(Status)) {
        nxWriteToLogFile(L"nxrmvhd!DriverEntry: Leave, failed");
        return Status;
    }
...
try_exit: NOTHING;
    ...
    nxWriteToLogFile(L"nxrmvhd!DriverEntry: Leave");
    return Status;
}
...
{
    nxWriteToLogFile(L"nxrmvhd!VhdUnload: Enter");
    ...
    nxWriteToLogFile(L"nxrmvhd!VhdUnload: Leave");
}
...
{
    UNREFERENCED_PARAMETER(DriverObject);
	nxWriteToLogFile(L"nxrmvhd!DummyUnload: Enter");
	nxWriteToLogFile(L"nxrmvhd!DummyUnload: Leave");
}
