...
#define IOCTL_NXRMVHD_CREATE_DISK       ((ULONG)CTL_CODE(FILE_DEVICE_NXRMVHD, NXRMVHD_IOCTL_BASE+6, METHOD_BUFFERED, FILE_ANY_ACCESS))
...
#define MAX_DISK_ID_VALUE               999  // Disk id value must be less than 999
...
#define VHD_PROPERTY_NT_NAME        0x00000001
#define VHD_PROPERTY_DOS_NAME       0x00000002
#define VHD_PROPERTY_READONLY       0x00000003
...
#define VHD_FLAG_PASSWORD_ENABLED       0x00000001
#define VHD_FLAG_ENCRYPTION_ENABLED     0x00000002
...
typedef struct _VHDFILEHEADER {
    ...
    UCHAR           UniqueId[16];
    LONGLONG        DiskSpace;
    UCHAR           DiskKey[64];    //  0 - 31: Encrypted Disk Key (CEK)
                                    // 32 - 63: Encrypted Unique Id
    UCHAR           Reserved1[32];  // Reserved, must be zero
