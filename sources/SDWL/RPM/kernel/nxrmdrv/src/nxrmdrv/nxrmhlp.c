	...
	)
{
	...
	do 
	{
		...
		for(i = 0; i < 64; i++)
		{
			...
			if(!((Global.os_major == 6 && Global.os_minor >= 3) || Global.os_major == 10))
			{
				// Look for the instruction at the end of the function:
				// - "XCHG    AX, AX"
			...
			{
				// Look for the instructions at the end of the function:
				// - "RET"
				//   - Opcode   0xC3
				// - "NOP"
				//   - Opcode   0x90
