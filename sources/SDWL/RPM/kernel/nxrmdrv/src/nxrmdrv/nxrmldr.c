...
BOOLEAN is_process_a_service(PEPROCESS  Process)
{
	...
	do 
	{
		...
		status = SeQueryInformationToken(pPrimaryToken,TokenUser,(PVOID*)&pTokenUser);
		...
		pUserSid = (PISID)pTokenUser->User.Sid;
