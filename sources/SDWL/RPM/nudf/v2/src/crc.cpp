...
unsigned long NX::utility::calculate_crc32(const unsigned char* pb, unsigned long cb)
{
...
unsigned __int64 NX::utility::calculate_crc64(const unsigned char* pb, unsigned long cb)
{
    unsigned __int64 init_crc = 0;
    const unsigned char *p = (const unsigned char*)pb;
    init_crc ^= ~0ULL;
    while (cb--) {
