...
HANDLE async_pipe::server::listen_to_pipe(bool* pending) noexcept
{
    ...
    try {
        ...
        NX::win::security_attribute sa(NX::win::explicit_access(SECURITY_WORLD_SID_AUTHORITY, SECURITY_WORLD_RID, GENERIC_READ | GENERIC_WRITE, SUB_CONTAINERS_AND_OBJECTS_INHERIT));
