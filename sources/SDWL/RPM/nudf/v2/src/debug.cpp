...
std::string NX::dbg::build_error_msg2(const std::string& file_name, int line, const std::string& function_name, const std::string& category, const std::string format, ...)
{
    std::string s;
