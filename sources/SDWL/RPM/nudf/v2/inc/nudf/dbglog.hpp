...
#define DECLARE_LOG_CALLBACKS2()    static __inline NX::dbg::LOGLEVEL NxGlobalLogLevelNormalize(unsigned long level) {return (NX::dbg::LOGLEVEL)(level > NX::dbg::LL_ALL ? NX::dbg::LL_ALL : level); }  \
                                    NXLOG_ACCEPT NxGlobalLogAccept = NULL;  \
                                    NXLOG_WRITE NxGlobalLogWrite = NULL;
